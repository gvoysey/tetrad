...
for antigen = 1:Num_Antigens
   for cellLine = 1:Num_CellLines
       Antigens_Bloodspot.(Antigen_Dictionary{antigen}).(CellLine_Dictionary{cellLine}) = 2.^Antigens_Bloodspot.(Antigen_Dictionary{antigen}).(CellLine_Dictionary{cellLine});
   end
end
...
for antigen = 1:Num_Antigens
    ...
    for cellLine = 1:Num_CellLines
        if (~ ismember((CellLine_Dictionary{cellLine}),Healthy_Lines) )
            ...
            Antigens_Bloodspot.(Antigen_Dictionary{antigen}).(CellLine_Dictionary{cellLine}).normalized_mean = Antigens_Bloodspot.(Antigen_Dictionary{antigen}).(CellLine_Dictionary{cellLine}).mean  / meanOfmeans;
        end
    end
end
...
for antigen = 1:Num_Antigens
    for cellLine = 1:Num_CellLines
        if (~ ismember((CellLine_Dictionary{cellLine}),Healthy_Lines) )
            Antigens_Bloodspot.(Antigen_Dictionary{antigen}).(CellLine_Dictionary{cellLine}).normalized_log10       = log10( Antigens_Bloodspot.(Antigen_Dictionary{antigen}).(CellLine_Dictionary{cellLine}).normalized );
            Antigens_Bloodspot.(Antigen_Dictionary{antigen}).(CellLine_Dictionary{cellLine}).normalized_mean_log10  = log10( Antigens_Bloodspot.(Antigen_Dictionary{antigen}).(CellLine_Dictionary{cellLine}).normalized_mean );
        end
    end
end
